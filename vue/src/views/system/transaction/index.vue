<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="订单编号" prop="deviceId">
        <el-input
    ...
    <el-table v-loading="loading" :data="statusList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="订单编码" align="center" prop="deviceStatusId" />
      <el-table-column label="消费终端" align="center" prop="deviceStatusId" />
      <el-table-column label="支付渠道" align="center" prop="deviceStatusId" />
      <el-table-column label="渠道ID" align="center" prop="deviceStatusId" />
      <el-table-column label="消费时间" align="center" prop="deviceId" />
      <el-table-column label="订单金额" align="center" prop="deviceNum" />
      <el-table-column label="优惠金额" align="center" prop="relayStatus"  />
      </el-table-column>
    </el-table>
...
<script>
import { listStatus, getStatus, delStatus, addStatus, updateStatus, exportStatus } from "@/api/system/order";
